...
class _ChapterCardState extends State<ChapterCard> {
  ...
  Widget build(BuildContext context) {
    ...
    return Padding(
      padding:
          EdgeInsets.only(left: getProportionateScreenWidth(5), bottom: 20),
      child: GestureDetector(
          onTap:
              controller.lastChapter + 1 >= widget.index ? widget.press : () {},
          child: Opacity(
            opacity: controller.lastChapter + 1 >= widget.index ? 1 : 0.5,
            child: Card(
              child: Padding(
